...
import { CardReplacementExecutor } from './executor';
...
app.get('/health', (req, res) => {
  res.json({ 
    status: 'healthy', 
    service: 'card-replacement-agent',
    port: PORT,
...
// Start server
app.listen(PORT, () => {
  console.log(`Card Replacement Agent running on port ${PORT}`);
...
process.on('SIGINT', () => {
  console.log('\nShutting down Card Replacement Agent...');
